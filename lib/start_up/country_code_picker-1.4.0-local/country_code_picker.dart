// SOURCE- https://pub.dev/packages/country_code_picker (v1.4.0)
...
class CountryCodePicker extends StatefulWidget {
  ...
  /// Set to true if you want to see dropdown icon (mod)
      ...
      _widget = FlatButton(
        ...
        child: Flex(
          ...
          children: <Widget>[
            ...
            if (widget.showDropIcon != null ? widget.showDropIcon : false) Icon(Icons.arrow_drop_down, color: Colors.white, size: displayWidth(context) * 0.07)
          ],
        ),
      );
    }
