...
import 'package:fieldhand/widgets/flutter_rounded_date_picker-1.0.4-local/src/flutter_rounded_button_action.dart';
import 'package:fieldhand/widgets/flutter_rounded_date_picker-1.0.4-local/src/material_rounded_date_picker_style.dart';
import 'package:fieldhand/widgets/flutter_rounded_date_picker-1.0.4-local/src/material_rounded_year_picker_style.dart';
import 'package:fieldhand/widgets/flutter_rounded_date_picker-1.0.4-local/src/widgets/flutter_rounded_date_picker_header.dart';
import 'package:fieldhand/widgets/flutter_rounded_date_picker-1.0.4-local/src/widgets/flutter_rounded_day_picker.dart';
import 'package:fieldhand/widgets/flutter_rounded_date_picker-1.0.4-local/src/widgets/flutter_rounded_month_picker.dart';
import 'package:fieldhand/widgets/flutter_rounded_date_picker-1.0.4-local/src/widgets/flutter_rounded_year_picker.dart';
          ...
          case Orientation.portrait:
            return Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  header,
                  SizedBox(height: widget.height, child: picker),
                  actions,
                ],
              ),
            );
